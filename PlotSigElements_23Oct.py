...
if __name__ == '__main__':
    ...
    elements_input_file = 'analysis_exclVEP/combined_rand103setsTFsigQval0.05_meanTFExprMotifBreaking03Filters_mergedmuts200bpSimSig1.0localw25000onlysig0.05_merged_intersectedmuts_grouped_aggregated0UpDwmaxdist2kb_within500kb.tsv'
    sig_tfs_file = 'analysis_exclVEP/combined_rand103setsTFsigQval0.05_sigTFs_0.05.tsv'
    sig_tfpos_file = 'analysis_exclVEP/combined_rand103setsTFsigQval0.05_sigTFpos_0.05.tsv'
    input_file = 'analysis_exclVEP/All-tumors-without-Lymphatic-system-Skin-Melanoma_obsann22May2017_exclVEP.bed9_rand103setsTFsigQval0.05'
    
    output_file_ext="analysis_exclVEP/Fig_"
    read_sig_elements_file(elements_input_file, output_file_ext)
    
    output_file_ext = 'analysis_exclVEP/sigTFs_'
    ...
    output_file_ext = 'analysis_exclVEP/sigTFpos_'
    ...
    plot_sig_tfs(sig_tfpos_file, output_file_ext=output_file_ext+"_lmplot", key_name='TF Positions', threshold_to_include_element=100, fdr_log10neg_threshold=2, 
                 cohorts=['All-tumors-without-Lymphatic-system-Skin-Melanoma'], num_labels_to_write=10)
    #plot_mutation_rate_per_cancer_type(output_files_mutation_rate="analysis_exclVEP/mutationratepersamplepercancertype", observed_mutation_file='mutations_files/observed.bed9')
    
    output_file_ext = 'analysis_exclVEP/FuncMotifsAllTumorsNoLymphSKin_'
