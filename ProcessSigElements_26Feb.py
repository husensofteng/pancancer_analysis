...
def generate_genesets_genes_dict(geneset_files):
    ...
    cosmic_genes_file = "/home/huum/projs/pancan12Feb2020/GeneExp_datafiles/cancer_gene_census.csv"
    kegg_pathways_file = "/home/huum/projs/pancan12Feb2020/GeneExp_datafiles/kegg_pathways_fromdb_madeAgenesetPerPathway.gmt"
    pcawg_drivers_file = "/home/huum/projs/pancan12Feb2020/cancer_datafiles/PCAWG_cancer_drivers_fulllist.txt"
...
def getSigElements(generated_sig_merged_element_files, n, max_dist, window):
    ...
    aggregated_output_file = '/home/huum/projs/pancan12Feb2020/pancan_output_12Feb/combined{ext}_merged_intersectedmuts_grouped_aggregated{n}{up}{dw}maxdist{max_dist}kb_within{window}kb.tsv'.format(ext=ext, n=n, up="Up", dw="Dw", max_dist=max_dist/1000, window=window/1000)
    ...
    combined_mut_grouped_file = '/home/huum/projs/pancan12Feb2020/pancan_output_12Feb/combined{ext}_merged_intersectedmuts_grouped_recurrent.col12'.format(ext=ext)
...
def combine_sig_TFs(sig_tfs_files, tf_label='TFs'):
    ...
    aggregated_output_file = '/home/huum/projs/pancan12Feb2020/pancan_output_12Feb/combined{ext}.tsv'.format(ext=ext)
    if os.path.exists(aggregated_output_file):
        return aggregated_output_file
...
if __name__ == '__main__':
    ...
    mutation_input_dir = '/home/huum/projs/pancan12Feb2020/pancan_output_12Feb'
