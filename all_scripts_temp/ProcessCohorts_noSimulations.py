...
def process_cohorts(cohort_names_input, mutations_cohorts_dir, observed_input_file):
...
if __name__ == '__main__':
    ...
    cohort_names_input = 'meta_tumor_cohorts_v2_22May2017/cohorts_to_run_definedPCAWG_test'
    mutations_cohorts_dir = 'mutations_cohorts_output_test'#_Alltumors_noexon'
    observed_input_file = 'mutations_files/obsann22May2017_exclVEP.bed9'
    #simulated_input_dir = 'mutations_simulations_files_103sets_test'
    generated_sig_merged_element_files, sig_tfs_files, sig_tfpos_files = process_cohorts(cohort_names_input, mutations_cohorts_dir, observed_input_file)
